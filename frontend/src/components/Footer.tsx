      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          <div className="flex items-center gap-3 mb-4 min-w-0">
            <img src="/logo/mayura-heritage-crafts-logo.jpeg" alt="Mayura Heritage Crafts Logo" className="w-10 h-10 object-contain bg-cream rounded-full border border-cream/20 flex-shrink-0" />
            <h3 className="text-lg md:text-xl font-serif font-bold truncate">{settings?.siteName || "Mayura Heritage Crafts"}</h3>
          </div>
