      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-14 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 md:gap-3 min-w-0 flex-shrink">
            <img src="/logo/mayura-heritage-crafts-logo.jpeg" alt="Mayura Heritage Crafts Logo" className="w-10 h-10 md:w-20 md:h-20 object-contain mix-blend-multiply flex-shrink-0" />
            <div className="min-w-0">
              <h1 className="text-base md:text-3xl font-serif font-bold text-foreground leading-tight truncate">
                {settings?.siteName || "Mayura Heritage Crafts"}
              </h1>
              <p className="text-xs text-muted-foreground hidden md:block">{settings?.tagline || "Where Heritage Becomes a Living Experience."}</p>
            </div>
          </Link>
